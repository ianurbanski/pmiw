...
//trabajo hecho en conjunto con juan ignacion ventamiglia
...
function draw() {
  ...
  if (indiceImagen === 0 && botonActivo) {
    botonSonido(270, 50, 100, 40, "Iniciar sonido");
  }
 ...
 //Botones
  if (indiceImagen === 6 || indiceImagen === 17) {
    botonesDecision(40, 220, 100, 40, "A", 500, 220, "B");
  } else if (indiceImagen === 20) {
    botonReinicio(279, 280, 100, 40, "Reiniciar");
  } else {
    botonPasar(320, 240, 50);
  }
